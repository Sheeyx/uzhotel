...
const ROOMS_BASE: RoomBase[] = [
  {
    ...
    priceIntl: 470_000,
    images: [
      P("room/single/single1.png"),
      P("room/single/single3.png"),
      P("room/single/single4.png"),
      P("room/single/single2.png"),
      P("room/single/single5.png"),
    ],
  ...
  },
  {
    ...
    priceIntl: 550_000,
    images: [
      P("room/two/tworoom1.png"),
      P("room/two/tworoom2.png"),
      P("room/two/tworoom4.png"),
      P("room/two/tworoom5.png"),
      P("room/two/tworoom6.png"),
    ],
    type: "standard_twin",
  ...
  },
  {
    ...
    priceIntl: 670_000,
    images: [
      P("room/triple/triple1.png"),
      P("room/triple/triple2.png"),
      P("room/triple/triple3.png"),
      P("room/triple/triple4.png"),
      P("room/triple/triple5.png"),
    ],
  ...
  },
  {
    ...
    priceIntl: 860_000,
    images: [
      P("room/family/family1.png"),
      P("room/family/family4.png"),
      P("room/family/family1.png"),
      P("room/family/family4.png"),
      P("room/family/family5.png"),
    ],
    type: "suite_single",
  ...
  },
  {
    ...
    priceIntl: 990_000,
    images: [
      P("room/luxurysingle/room1.png"),
      P("room/luxurysingle/room2.png"),
      P("room/luxurysingle/room3.png"),
      P("room/luxurysingle/room4.png"),
      P("room/luxurysingle/room5.png"),
    ],
    type: "suite_single",
    amenities: ["breakfast", "wifi", "parking"],
  },
  {
    ...
    priceIntl: 1_150_000,
    images: [
      P("room/luxurytwo/room1.png"),
      P("room/luxurytwo/room2.png"),
      P("room/luxurytwo/room3.png"),
      P("room/luxurytwo/room4.png"),
      P("room/luxurytwo/room5.png"),
    ],
    type: "suite_double",
